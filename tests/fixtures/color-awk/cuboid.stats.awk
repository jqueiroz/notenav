{ types[$1]++; combos[$1, $2]++ } END {
  n = split("taskideareferenceritual", order, "\\036")
  icon["task"] = "◆"; clr["task"] = "\033[36m"; icon["idea"] = "✦"; clr["idea"] = "\033[35m"; icon["reference"] = "▪"; clr["reference"] = "\033[33m"; icon["ritual"] = "◎"; clr["ritual"] = "\033[32m"; 
  sc["new"] = "\033[90m"; sc["active"] = "\033[32m"; sc["blocked"] = "\033[31m"; sc["done"] = "\033[90m"; 
  first = 1
  for (o = 1; o <= n; o++) {
    t = order[o]
    ...
    printf " ("
    sn = split("newactiveblockeddone", statuses, "\\036")
    sfirst = 1
    for (si = 1; si <= sn; si++) {
      s = statuses[si]
      key = t SUBSEP s
