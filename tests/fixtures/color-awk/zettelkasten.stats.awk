{ types[$1]++; combos[$1, $2]++ } END {
  n = split("fleetingliteraturepermanent", order, "\\036")
  icon["fleeting"] = "◇"; clr["fleeting"] = "\033[33m"; icon["literature"] = "▪"; clr["literature"] = "\033[34m"; icon["permanent"] = "◆"; clr["permanent"] = "\033[36m"; 
  sc["draft"] = "\033[33m"; sc["review"] = "\033[34m"; sc["mature"] = "\033[32m"; sc["archived"] = "\033[90m"; 
  first = 1
  for (o = 1; o <= n; o++) {
    t = order[o]
    ...
    printf " ("
    sn = split("draftreviewmaturearchived", statuses, "\\036")
    sfirst = 1
    for (si = 1; si <= sn; si++) {
      s = statuses[si]
      key = t SUBSEP s
