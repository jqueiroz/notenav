...
For creating, searching, and managing notes from the command line, use [zk](https://github.com/zk-org/zk) directly — notenav builds on top of it as a visual layer.
